...
#include "MPMotionCaptureWebSocketServer.generated.h"

UCLASS()
class MPMOCAP_API AMPMotionCaptureWebSocketServer : public AActor
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	AMPMotionCaptureWebSocketServer();
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "MPMotionCaptureWebSocketServer")
	void OnDataCallback(const FString &addr, const TArray<float> &data);

public:
	// Open WebSocket Server
	UFUNCTION(BlueprintCallable, Category = "MPMotionCaptureWebSocketServer")
	bool Start(int Port);
