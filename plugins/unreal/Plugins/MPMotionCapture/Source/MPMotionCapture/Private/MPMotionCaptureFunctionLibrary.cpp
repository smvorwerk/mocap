...
#include "MPMotionCaptureFunctionLibrary.h"

bool UMPMotionCaptureFunctionLibrary::BlendshapeDataRemap(TArray<float> floatArrayData, FMPMotionCaptureBlendshapeData& blendshapeData) {
